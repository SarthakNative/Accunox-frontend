...
export default function CategoryManager({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      {/* Side Popup */}
      <div className="fixed top-0 right-0 h-screen w-full max-w-[480px] bg-white shadow-xl z-50 flex flex-col transform transition-transform duration-300 ease-out">
